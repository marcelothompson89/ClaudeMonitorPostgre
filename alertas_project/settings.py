...
ALLOWED_HOSTS = [
                'monitorregulatoriomt.onrender.com', 
                'localhost', 
                '127.0.0.1'
                ]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'alertas/templates'),
            os.path.join(BASE_DIR, 'alertas/templates/alertas'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# URLs de redirección para login/logout
LOGIN_URL = '/login/'
